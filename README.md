...
- [Introduction to Odin](https://zylinski.se/posts/introduction-to-odin/) is a great article by Karl Zylinski about Odin basics
...
| [PhysX](https://github.com/tgolsson/physx-odin) | Bindings for [PhysX 5.1](https://github.com/NVIDIA-Omniverse/PhysX) based on [physx-rs](https://github.com/EmbarkStudios/physx-rs) | Gamedev, Physics
